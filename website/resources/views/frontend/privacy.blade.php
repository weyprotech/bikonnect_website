...
<main id="main">
    <div class="privacy_polity page_block">
        ...
        <h1 class="block_title">PRIVACY POLICY OF MICROPROGRAM INFORMATION Co., Ltd.<br>Update</h1>
        <div class="text">
            ...
            <p>The protection of personal information collected through any website which is linked from the Website and is independently managed and operated by a third party shall be subject to privacy policy of that third party or website. Microprogram does not endorse such policies or website assume any joint liability thereof.</p>
            <p>Microprogram reserves rights to unilaterally modify this Policy, and if users continue to use Microprogram’s website services after Microprogram publish or send the notification of any change to this Policy, such users will be deemed to have acknowledged that modification.</p><br>
            <h2 class="block_subtitle">1. Personal information to be collected and used by Microprogram</h2>
            <p>When users initiate contact Microprogram intending to utilize services provided through Microprogram’s website, users may need to provide their personal information including name, phone number, and email. Microprogram will process and use users’ personal information for such request of service. Without users’ written consent, Microprogram will not use users’ personal information for any other purpose. The Website does not collect any information about an individual’s identity if users only browse the Website or download files.</p>
            <p>When users use Microprogram’s app or other services, Microprogram needs to use users’ personal information for specified purposes As a general rule, when users open users accounts, at first Microprogram will request the following personal information from users: name, password, E-mail address, gender, birthday, height, weight, location, profile picture.</p>
            <p>Users’ personal information is required in order to enable Microprogram to enter into a user agreement and any other agreement with users and perform under these agreements. Personal information provided by filling and submitting a contact form is also necessary to enable Microprogram to respond appropriately to any inquiries. Microprogram will store users personal information in Taiwan as long as necessary for aforementioned purposes. Thereafter, it will be deleted from Microprogram’s system.</p>
            <p>To enable users to use Microprogram’s service, Microprogram will collect personal information and technical data in the context of the provision of Microprogram’s service, which including: IP address, position related data (GPS), drive unit data, e-bike manufacturer, display data on bike, addresses of stores and navigation records; heart rate, movement speed, watts of movement, odograph records, data of battery power , cadence, consumed calories, torque sensor records, other logs, assistance mode usage. The personal and technical data collected ensures that users are able to avail themselves of Microprogram’s services.</p><br>
            <h2 class="block_subtitle">2. Cookies</h2>
            <p>Cookies are files with a small amount of data that is commonly used as an anonymous unique identifier. These are sent to users’ browser from the website that users visit and are stored on users’ devices’ internal memory. The App may use third party code and libraries that utilizing “cookies” to collect information and to improve their services.</p>
            <p>Users will be alarmed when a cookie is sent to users’ devices, and Users may either accept or refuse these cookies . If users choose to refuse Microprogram’s cookies, such users may not be able to use some parts of service.</p>
            <p>Microprogram’s website uses cookies to identify users’ preferences on the website. In these cookies, Microprogram uses the so-called “Track ID” function to track a user’s behavior, for example, tracking the web pages browsed by the user, stay time, device information, and Microprogram will use such information as a reference for adjusting the website content. Microprogram also use Google Analytics to analyze the users’ online behaviors as part of website traffic statistics. The privacy policy of Google Analytics is available on https://policies.google.com/technologies/cookies?hl=en.</p>
            <p>The “Track ID” function used by the Website is an anonymous tracker. A user is not required to provide any personal information if he/she just browse the website anonymously. Therefore, Microprogram will not be able to link this Track ID to any private information, including email, mobile number, or address. That means Microprogram will not know the true identity of any user through this Track ID function.</p>
            <p>Besides cookies, Microprogram also collect additional information as below:</p>
            <ul>
            <li>URL visited by the user</li>
            <li>User’s source address and IP address</li>
            <li>Brand, model no. and operating system of user’s connection device</li>
            <li>Browser type, resolution and color support of user’s connection device</li>
            <li>Geographical information about where user connect to internet (for example, reserved lookup records indirectly through a third-party GeoIP)</li>
            <li>The ISP service provider of user who connect to internet (for example, reserved lookup records indirectly through a third-party GeoIP)</li>
            </ul><br>
            <h2 class="block_subtitle">3. How Do Microprogram Use the Information</h2>
            <ul class="number_list">
            <li>
                <div class="number">3.1.</div>To respond to users’ inquiry<br>To professionally response to the users’ inquiries, and provide relevant product information for the users’ reference.
            </li>
            <li>
                <div class="number">3.2.</div>To learn and optimize website content<br>Microprogram’s website uses the information collected as aforementioned to research on how to optimize the website content through artificial intelligence, machine learning, big data, and other analytic methods.
            </li>
            </ul><br>
            <h2 class="block_subtitle">4. How Microprogram Share the Information</h2>
            <ul class="number_list">
            <li>
                <div class="number">4.1.</div><strong>The party with whom Microprogram share the information</strong><br>The personal device records and cookie records of the users collected through Microprogram’s website services as mentioned above are solely for Microprogram’s internal use, and will not be shared with any third party, nor will Microprogram provide the browsing history and other sensitive personal information of individual users to any third party, unless:
                <ul class="number_list">
                <li>
                    <div class="number">4.1.1.</div>Users have agreed in writing;
                </li>
                <li>
                    <div class="number">4.1.2.</div>It is required by any applicable laws, regulations, orders, or lawful governmental request;
                </li>
                <li>
                    <div class="number">4.1.3.</div>It is to detect, prevent, or deal with any security or technical issue (such as investigating a possible violation).
                </li>
                </ul>
            </li>
            <li>
                <div class="number">4.2.</div><strong>Information retention period</strong><br>The original log files of the personal device records and cookie records of the users collected by Microprogram’s website services as above will be kept at Microprogram’s data center for 1 month. Past log files will be deleted month by month.
            </li>
            </ul><br>
            <h2 class="block_subtitle">5. How do Microprogram Protect Personal information</h2>
            ...
            <ul class="number_list">
            <li>
                <div class="number">5.1.</div>Install firewalls to prevent hacking, destruction or theft of data, avoid illegal use of the website, and protect users’ interests.
            </li>
            <li>
                <div class="number">5.2.</div>Conduct daily back-ups.
            </li>
            <li>
                <div class="number">5.3.</div>Run weakness screening and enhance the security of the operating system and the webserver.
            </li>
            </ul><br>
            <h2 class="block_subtitle">6. Users’ Rights</h2>
            <p>Users may (1) access to personal information, (2) request for correction and deletion of personal information, (3) withdrawal of consent (4) request for data portability (5) restrict or object to processing of persona; information (6) lodge a complaint with EU Information Commissioner’s Office.</p><br>
            <h2 class="block_subtitle">7. Cross-border transmission</h2>
            <p>As stated in paragraph 4.1, the personal information collected through Microprogram’s website services are solely for internal utilization. All network communications of direct or cross-border transmission of personal information will only occur under an encrypted environment for secure internet connection such as SSL or HTTPS. All communications are subject to the SSL 2048 bit encryption to ensure data security throughout the transmission.</p><br>
            <h2 class="block_subtitle">8. Contact information:</h2>
            <p>If users have any question about this Policy or need to file any complaint, please contact us by the following methods:</p>
            <ul>
            <li>Company: Microprogram Information Co., Ltd.</li>
            <li>Tel: <a href="tel:+886-4-2369-2699">+886-4-2369-2699</a></li>
            <li>Email: <a href="mailto:smart_ebike@program.com.tw">smart_ebike@program.com.tw</a></li>
            </ul>
        </div>
        </div>
    </div>
