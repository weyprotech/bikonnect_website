                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form id="form" method="post" action="{{ route('term.order_save') }}">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <a class="btn btn-success btn-labeled" type="button" href="{{ URL::route('term.add') }}"> <span class="btn-label"><i class="fa fa-plus"></i></span>新增隱私權條款</a>
                                            </div>
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @foreach($contentList as $contentKey => $contentValue)
                                                <tr>                                                    
                                                    <td>{!! nl2br(e($contentValue->privacyTermlang[0]->title)) !!}</td>
                                                    <td>
                                                        <label class="input">
                                                    ...
                                                    <td class="text-center"><a href="{{ route('term.edit', $contentValue->Id) }}" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a></td>
                                                    <td class="text-center"><a href="{{ route('term.delete',$contentValue->Id) }}" class="btn btn-danger btn-xs del" onclick="return confirm('確定要刪除?');"><i class="fa fa-trash-o"></i></a></td>                                                
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
