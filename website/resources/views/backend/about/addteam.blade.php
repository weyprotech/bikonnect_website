                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data" action="{{ route('about.team.add') }}"
                                        ...
                                        <div class="tab-pane" id="hb_{{ $langKey+2 }}">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input type="text" class="form-control" name="teamlangs[{{ $langValue->langId }}][title]" value=""
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <input type="text" class="form-control" name="teamlangs[{{ $langValue->langId }}][name]" value=""
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <textarea class="form-control" name="teamlangs[{{ $langValue->langId }}][content]" placeholder="內文" rows="4" data-bv-notempty="true" data-bv-notempty-message="請輸入內文"></textarea>
                                                    </div>
                                                </div>  
