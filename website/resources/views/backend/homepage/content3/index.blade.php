                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-inline">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <a class="btn btn-success btn-labeled" type="button" href="{{ URL::route('content3.add') }}"> <span class="btn-label"><i class="fa fa-plus"></i></span>新增內文3</a>
                                            </div>
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @foreach($contentList as $contentKey => $contentValue)
                                                <tr>                                                    
                                                    <td>{!! nl2br(e($contentValue->content3lang[0]->title)) !!}</td>
                                                    <td>
                                                        <label class="input">
                                                    ...
                                                    <td class="text-center"><a href="{{ route('content3.edit', $contentValue->Id) }}" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a></td>
                                                    <td class="text-center"><a href="{{ route('content3.delete',$contentValue->Id) }}" class="btn btn-danger btn-xs del" onclick="return confirm('確定要刪除?');"><i class="fa fa-trash-o"></i></a></td>                                                
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
