    ...
    <div id="wrapper">
      ...
      <main id="main">
        <div class="product_introduction page_block">
          <div class="block_inner proportion">
            <div class="block_content">
              <h1 class="block_title">E-Bike store management system</h1>
              <div class="text">
                <p>The E-Bike store management system is designed for digital services of bicycle stores, so through this system branch managers provide the most real-time service to cyclists, including online appointment for maintenance and repair, digital maintenance history, appointment reminders and other friendly services. </p>
              </div>
            </div>
            <div class="block_img"><img src="<?= $img_url."images/products/product04/intro.png" ?>" alt=""></div>
          </div>
        </div>
        <div class="product_characteristic page_block">
          ...
          <div class="block_inner proportion">
            <div class="block_content">
              <h2 class="block_subtitle">Improve Services</h2>
              <div class="text">
                <p>These stores could monitor the real-time bike information for bikers, as well as let the relationship between cyclists and dealers longer and closer, which improves the after-sales service quality and customer satisfaction of these stores.</p>
              </div>
            </div>
            <div class="block_img"><img src="<?= $img_url."images/products/product04/characteristic.png" ?>" alt=""></div>
          </div>
        ...
        <div class="product_keyAdvantages page_block">
          <div class="block_inner">
            <div class="block_content">
              ...
              <ul class="key_list">
                <li>Get real-time information about members and their bikes</li>
                <li>Schedule available time for online appointment</li>
                <li>Visualized appointment calendar management</li>
                <li>Build up bike maintenance history </li>
                <li>Catch the maintenance and repair statistics easily</li>
                <li>Assign easily to store management authorization</li>
              </ul>
            </div>
            <div class="block_img"><img src="<?= $img_url."images/products/product04/key.png" ?>" alt=""></div>
          </div>
        </div>
        <div class="product_future page_block">
          <div class="block_inner">
            <h2 class="block_subtitle">Connect your bike<br>Ride the future</h2>
            <div class="image_video"><img src="<?= $img_url."images/products/product04/future.jpg" ?>" alt=""></div>
          </div>
        </div>
        <div class="product_application page_block">
          <div class="block_inner">
            ...
            <div class="aplication_items">
              <div class="item">
                <div class="icon_img"><img src="<?= $img_url."images/products/product04/icon_img01.png" ?>" alt=""></div><span>Bike dealers / Bike stores </span>
              </div>
            </div>
          </div>
        </div>
        <div class="contact page_block" data-anchor="contact">
          <div class="block_inner">
            ...
            <div class="contact_form">
              <form action="<?= $front_url."product04.php" ?>" method="post">
