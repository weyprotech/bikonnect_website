      ...
      <main id="main">
        <div class="product_introduction page_block">
          <div class="block_inner proportion">
            ...
            <div class="block_img"><img src="<?= $img_url."images/products/product05/intro.png" ?>" alt=""></div>
          </div>
        </div>
        <div class="product_characteristic page_block">
          ...
          <div class="block_inner proportion">
            <div class="block_content">
              ...
              <div class="text">
                <p>Additionally, through the E-Bike computer, the cycling data could be synchronized to APP and uploaded to cloud storage which provides a perfect and convenient E-bike experience no matter whether for casual or commuter cyclists. </p>
              </div>
            </div>
            <div class="block_img"><img src="<?= $img_url."images/products/product05/characteristic.png" ?>" alt=""></div>
          </div>
        ...
        <div class="product_keyAdvantages page_block">
          <div class="block_inner">
            <div class="block_content">
              ...
              <ul class="key_list">
                <li>E-bike computer designed for E-Bike commuter and leisure users</li>
                <li>Battery status/Assist mode/Speed/Real-time Display</li>
                <li>Update the firmware with Bluetooth and APP</li>
                <li>Connected to E-Bike APP</li>
                <li>USB device recharging</li>
                <li>CAN BUS communication interface</li>
              </ul>
            </div>
            <div class="block_img"><img src="<?= $img_url."images/products/product05/key.png" ?>" alt=""></div>
          </div>
        </div>
        <div class="product_future page_block">
          <div class="block_inner">
            <h2 class="block_subtitle">Connect your bike<br>Ride the future</h2>
            <div class="image_video"><img src="<?= $img_url."images/products/product05/future.jpg" ?>" alt=""></div>
          </div>
        </div>
        <div class="product_application page_block">
          <div class="block_inner">
            ...
            <div class="aplication_items">
              <div class="item">
                <div class="icon_img"><img src="<?= $img_url."images/products/product05/icon_img01.png" ?>" alt=""></div><span>E-Bike</span>
              </div>
            </div>
          </div>
        </div>
        <div class="contact page_block" data-anchor="contact">
          <div class="block_inner">
            ...
            <div class="contact_form">
              <form action="<?= $front_url."product05.php" ?>" method="post">
