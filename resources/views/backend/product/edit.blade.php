                                        ...
                                        <div class="tab-pane" id="hb_{{ $langValue->langId }}">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <textarea class="form-control" name="productlangs[{{ $langValue->langId }}][title_2]" placeholder="內文" rows="8" data-bv-notempty="true" data-bv-notempty-message="請輸入內文">{{ $langdata[$langValue->langId]->title_2 }}</textarea> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <p>
                                                            <img id="preview_{{$langValue->langId}}_5" src="{{ $langdata[$langValue->langId]->img_5 }}" width="auto" style="max-width:250px" />
                                                        </p>
