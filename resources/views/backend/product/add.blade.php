                                        ...
                                        <div class="tab-pane {{ $langKey == 0 ? 'active' : '' }}" id="hb_{{ $langValue->langId }}">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="productlangs[{{ $langValue->langId }}][title]" value=""
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="productlangs[{{ $langValue->langId }}][meta_title]"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="productlangs[{{ $langValue->langId }}][meta_description]"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="productlangs[{{ $langValue->langId }}][meta_keywords]"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="productlangs[{{ $langValue->langId }}][title_1]"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="productlangs[{{ $langValue->langId }}][title_3]"
                                                        data-bv-notempty="true"
                                                        data-bv-notempty-message="請輸入標題"
                                                        >
                                                    </div>
