                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data" action="{{ route('blog.category.edit',$category->Id ) }}"
                            ...
                            <input type="hidden" name="uuid" value="{{ $category->uuid }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <label class="radio radio-inline">
                                                        <input type="radio" class="radiobox" name="is_visible" value="1" {{ $category->is_visible == 1 ? 'checked' : '' }}>
                                                        <span>是</span>
                                                    </label>

                                                    <label class="radio radio-inline">
                                                        <input type="radio" class="radiobox" name="category" value="0" {{ $category->is_visible == 0 ? 'checked' : '' }}>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    @foreach($web_langList as $langKey => $langValue)
                                        <div class="tab-pane" id="hb_<?= $i++ ?>">
                                            <fieldset>
                                                ...
                                                <input type="hidden" name="categorylangs[{{ $langValue->langId }}][cId]" value="{{ $category->Id }}">
                                ...
                                <div class="form-actions">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a class="btn btn-default" href="{{ route('blog.category') }}">
                                                Back
                                            </a>
