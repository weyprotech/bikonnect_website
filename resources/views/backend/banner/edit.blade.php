                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data" action="{{ route('banner.edit',$banner->bannerId ) }}"
                                    ...
                                    <div class="tab-pane active" id="hb_<?= $i++ ?>">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <label class="radio radio-inline">
                                                        <input type="radio" class="radiobox" name="is_visible" value="1" {{$banner['is_visible'] == 1 ? 'checked' : ''}}>
                                                        <span>是</span>
                                                    </label>

                                                    <label class="radio radio-inline">
                                                        <input type="radio" class="radiobox" name="is_visible" value="0" {{$banner['is_visible'] == 0 ? 'checked' : ''}}>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p>
                                                        <img id="preview" width="auto" src="{{ $banner['bannerImg'] }}" style="max-width:250px" />
                                                    </p>
