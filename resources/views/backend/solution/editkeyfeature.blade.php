                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data" action="{{ route('solution.key_feature.edit',$row->Id ) }}"
                            ...
                            <input type="hidden" name="uuid" value="{{ $row->uuid }}">
                                    ...
                                    <div class="tab-pane active" id="hb_<?= $i++ ?>">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p>
                                                        <img id="preview" width="auto" src="{{ $row['Img'] }}" style="max-width:250px" />
                                                    </p>
                                        ...
                                        <div class="tab-pane" id="hb_<?= $i++ ?>">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <textarea class="form-control" rows="5" name="contentlangs[{{ $langValue->langId }}][content]" data-bv-notempty="true" data-bv-notempty-message="請輸入內文">{!! $langdata[$langValue->langId]->content !!}</textarea>
                                                    </div>
                                                </div>                                                                                             
                                            </fieldset>
                                        </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a class="btn btn-default" href="{{ route('solution.key_feature') }}">
                                                Back
                                            </a>
