                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">                            
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data" action="{{ route('solution.edit',$solution->Id) }}"
                                    ...
                                    <div class="tab-pane active" id="hb_0">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <input type="text" id="url" class="form-control" name="url" value="{{ $solution->url }}" data-bv-notempty="true" data-bv-notempty-message="請輸入產品連結" pattern="[A-Za-z0-9_]+" data-bv-regexp-message="只能輸入英文、數字、底線" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p>
                                                        <img id="preview" width="auto" src="{{ $solution->Img }}" style="max-width:140px" />
                                                    </p>
                                        ...
                                        <div class="tab-pane" id="hb_{{ $langValue->langId }}">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][title]" value="{{ $langdata[$langValue->langId]->title }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][meta_title]" value="{{ $langdata[$langValue->langId]->meta_title }}"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][meta_description]" value="{{ $langdata[$langValue->langId]->meta_description }}"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][meta_keywords]" value="{{ $langdata[$langValue->langId]->meta_keywords }}"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][video_youtube]" value="{{ $langdata[$langValue->langId]->video_youtube }}"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <textarea class="form-control" name="contentlangs[{{ $langValue->langId }}][video_content]" placeholder="內文" rows="4" data-bv-notempty="true" data-bv-notempty-message="請輸入內文">{{ $langdata[$langValue->langId]->video_content }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        ...
                                                        data-bv-notempty="true"
                                                        data-bv-notempty-message="請輸入圖文區標題-1" value="{{ $langdata[$langValue->langId]->content_title_1 }}"
                                                        >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <p>
                                                            <img id="preview_{{ $langValue->langId }}_img1" src="{{ $langdata[$langValue->langId]->content_img_1 }}" width="auto" style="max-width:250px" />
                                                        </p>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="content-edit">{!! $langdata[$langValue->langId]->content_content_1 !!}</div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][content_title_2]" value="{{ $langdata[$langValue->langId]->content_title_2 }}"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <p>
                                                            <img id="preview_{{ $langValue->langId }}_img2" src="{{ $langdata[$langValue->langId]->content_img_2 }}" width="auto" style="max-width:250px" />
                                                        </p>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="content-edit">{!! $langdata[$langValue->langId]->content_content_2 !!}</div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][service_title]" value="{{ $langdata[$langValue->langId]->service_title }}"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <p>
                                                            <img id="preview_{{$langValue->langId}}_service_img" src="{{ $langdata[$langValue->langId]->service_img }}" width="auto" style="max-width:250px" />
                                                        </p>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][aspect_title_1]" value="{{ $langdata[$langValue->langId]->aspect_title_1 }}"
                                                        data-bv-notempty="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][aspect_title_2]" value="{{ $langdata[$langValue->langId]->aspect_title_2 }}"
                                                        data-bv-notempty="true"
