                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data" action="{{ route('content5.add') }}"
							...
							data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                        ...
                                        <div class="tab-pane" id="hb_<?= $i++ ?>">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <textarea class="form-control" name="contentlangs[{{ $langValue->langId }}][content]" placeholder="內文" rows="4" data-bv-notempty="true" data-bv-notempty-message="請輸入內文"></textarea>                                                        
                                                    </div>
                                                </div>                                                                                      
                                            </fieldset>
                                        </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a class="btn btn-default" href="{{ route('content5.index') }}">
                                                Back
                                            </a>
