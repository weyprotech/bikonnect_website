                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-sortable="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data" action="{{ route('content4.edit',$content->Id ) }}"
                                    ...
                                    <div class="tab-pane active" id="hb_<?= $i++ ?>">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <p>
                                                        <img id="preview" width="auto" src="{{ $content['Img'] }}" style="max-width:250px" />
                                                    </p>
                                        ...
                                        <div class="tab-pane" id="hb_<?= $i++ ?>">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][title]" data-bv-notempty="true" data-bv-notempty-message="請輸入標題" value="{!! $langdata[$langValue->langId]->title !!}">                                                        
                                                    </div>
                                                </div>     
                                                <div class="form-group">
                                                    <label class="col-lg-2 control-label">簡介</label>
                                                    <div class="col-lg-5">
                                                        <input type="text" class="form-control" name="contentlangs[{{ $langValue->langId }}][description]" data-bv-notempty="true" data-bv-notempty-message="請輸入簡介" value="{!! $langdata[$langValue->langId]->description !!}">                                                        
                                                    </div>
                                                </div>   
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-5">
                                                        <textarea class="form-control" rows="5" name="contentlangs[{{ $langValue->langId }}][content]" data-bv-notempty="true" data-bv-notempty-message="請輸入內容">{!! $langdata[$langValue->langId]->content !!}</textarea>
                                                    </div>
                                                </div>                                                                                             
                                            </fieldset>
                                        </div>
